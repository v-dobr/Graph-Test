...
| _Contacts.Read_ |    `Read user contacts` | アプリでユーザーの連絡先を読み取ることができるようにします。 |
...
| _Calendars.Read_ |    `Read calendars in all mailboxes`| サインインしているユーザーなしで、アプリですべての予定表のイベントを読み取ることができるようにします。 |
| _Calendars.ReadWrite_ |    `Read and write calendars in all mailboxes`| サインインしているユーザーなしで、アプリですべての予定表のイベントの作成、読み取り、更新、削除を行えるようにします。|
| _Contacts.Read_ |    `Read contacts in all mailboxes`| サインインしているユーザーなしで、アプリですべてのメールボックス内のすべての連絡先を読み取ることができるようにします。 |
| _Contacts.ReadWrite_ |    `Read and write contacts in all mailboxes` |サインインしているユーザーなしで、アプリですべてのメールボックス内のすべての連絡先の作成、読み取り、更新、削除を行えるようにします。|
...
| **ユーザーが関与するアプリ タスク** |  **必須スコープ** | **Azure 管理ポータルでのアクセス許可** |
|:-------------------------------|:---------------------|:---------------|
...
| **グループが関与するアプリ タスク** |  **必須スコープ** |  **Azure 管理ポータルでのアクセス許可** |
|:-------------------------------|:---------------------|:---------------|
